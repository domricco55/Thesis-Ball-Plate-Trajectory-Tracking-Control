...
namespace GlobalVars
{
	...
	uint8_t RunState = 0; //A boolean used to signify the end of the UI and the start of the main program.
...
void UserInterface(void)
{
	...
	while(GlobalVars::RunState == 0)
	{
		...
		else if (UXstate == 2)
		{
			...
			GlobalVars::RunState = 1; //Set run state to active to leave UI state
		}
