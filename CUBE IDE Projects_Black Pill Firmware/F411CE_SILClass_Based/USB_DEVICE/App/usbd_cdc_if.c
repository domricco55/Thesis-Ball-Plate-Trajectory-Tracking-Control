...
#include "../../Core/Inc/main.h" //This include is to link functions in main to Receive packet.
...
uint8_t usb_Rx_flag; //Extern defined in main - flag to indicate USB buffer has been written to
