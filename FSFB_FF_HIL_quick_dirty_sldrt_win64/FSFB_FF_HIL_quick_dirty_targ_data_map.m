    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(50)  = dumData; %prealloc
                    ...
                    section.data(16).dtTransOffset = 246;

                    ;% FSFB_FF_HIL_quick_dirty_P.UnitDelay1_InitialCondition
                    section.data(17).logicalSrcIdx = 16;
                    section.data(17).dtTransOffset = 248;
                    ...
                    section.data(24).dtTransOffset = 325;

                    ;% FSFB_FF_HIL_quick_dirty_P.Step_YFinal
                    section.data(25).logicalSrcIdx = 24;
                    section.data(25).dtTransOffset = 326;

                    ;% FSFB_FF_HIL_quick_dirty_P.Gain1_Gain_be
                    section.data(26).logicalSrcIdx = 25;
                    section.data(26).dtTransOffset = 327;

                    ;% FSFB_FF_HIL_quick_dirty_P.Gain3_Gain
                    section.data(27).logicalSrcIdx = 26;
                    section.data(27).dtTransOffset = 328;

                    ;% FSFB_FF_HIL_quick_dirty_P.DiscreteTimeIntegrator_gainval
                    section.data(28).logicalSrcIdx = 27;
                    section.data(28).dtTransOffset = 329;

                    ;% FSFB_FF_HIL_quick_dirty_P.DiscreteTimeIntegrator_IC
                    section.data(29).logicalSrcIdx = 28;
                    section.data(29).dtTransOffset = 330;
    ...
    targMap.checksum0 = 4270060495;
    targMap.checksum1 = 2872185705;
    targMap.checksum2 = 2658821165;
    targMap.checksum3 = 305722332;
