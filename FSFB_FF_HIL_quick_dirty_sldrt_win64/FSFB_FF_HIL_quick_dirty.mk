...
MAKECMD         = "C:/PROGRA~1/MATLAB/R2022a/bin/win64/gmake"
HOST            = ANY
BUILD           = yes
...
MODEL                := FSFB_FF_HIL_quick_dirty
MODULES              := FSFB_FF_HIL_quick_dirty_data.c FSFB_FF_HIL_quick_dirty_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c
MAKEFILE             := FSFB_FF_HIL_quick_dirty.mk
...
SLDRTDIR             := C:/PROGRA~1/MATLAB/R2022a/toolbox/sldrt
TARGETARCH           := win64
CC_LISTING           := 0
REBUILD_ALL          := 0
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := FSFB_FF_HIL_quick_dirty_ref.rsp
...
# additional includes
REQ_INCLUDES += ;C:/Users/domin/Documents/Sourcetree/Ball-Plate-Thesis;C:/Users/domin/Documents/Sourcetree/Ball-Plate-Thesis/FSFB_FF_HIL_quick_dirty_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
