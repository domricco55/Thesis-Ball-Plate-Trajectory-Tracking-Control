classdef BP_Knmtcs < handle
    %BP_Knmtcs This class generates the kinematic equations for the motion of the centers of
    ...
    methods
        function obj = BP_Knmtcs(Var_Defs, UJ_Knmtcs)
        ...
        function [vb2s, ab2s, constr_eqn_rws, Psi2vs] = Derive_B_Knmtcs(obj)
            %UNTITLED Construct an instance of this class
            %   Detailed explanation goes here 
            ...
            obj.vb2s = subs(obj.UJ_Knmtcs.v2s, obj.VDefs.symFunVec_r2, obj.VDefs.symFunVec_rb2);
            
            %Substitute the ball's displacement vector in the S2 (plate) frame for the
            %arbitrary dispaclement vector r2 of the u-joint kinematics acceleration equation
            obj.ab2s = subs(obj.UJ_Knmtcs.a2s, obj.VDefs.symFunVec_r2, obj.VDefs.symFunVec_rb2);
        ...
        function [vp2s, ap2s] = Derive_P_Knmtcs(obj)  
            %UNTITLED Construct an instance of this class
            %   Detailed explanation goes here
            
            %Substitute the plate's displacement vector in the S2 (plate) frame for the
            %arbitrary dispaclement vector r2 of the u-joint kinematics velocity equation
            obj.vp2s = subs(obj.UJ_Knmtcs.v2s, obj.VDefs.symFunVec_r2, obj.VDefs.symFunVec_rp2);
            
            %Substitute the plate's displacement vector in the S2 (plate) frame for the
            %arbitrary dispaclement vector r2 of the u-joint kinematics acceleration equation
            obj.ap2s = subs(obj.UJ_Knmtcs.a2s, obj.VDefs.symFunVec_r2, obj.VDefs.symFunVec_rp2);
        ...
        function [vb2s, ab2s, constr_eqn_rws, Psi2vs, vp2s, ap2s] = Derive_Both(obj)
            ...
            [vb2s, ab2s, constr_eqn_rws, Psi2vs] = obj.Derive_B_Knmtcs;
            [vp2s, ap2s] = obj.Derive_P_Knmtcs;
