classdef Var_Defs
    ...
    %Scalars
        ...
        N_z %Normal force at the contact point in the plate's z direction (only component in that frame)
        f_x %Component of friction force at the contact point in the plate's x direction
        f_y %Component of friction force at the contact point in the plate's y direction
    ...
    %Vectors
        ...
        Tg1
        Mz1
        N %Normal force vector in the plate frame
        F_f %Friction force vector in the plate frame
