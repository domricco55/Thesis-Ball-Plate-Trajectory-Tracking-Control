...
#ifndef RTW_HEADER_Meas_Noise_Test_private_h_
#define RTW_HEADER_Meas_Noise_Test_private_h_
#include "rtwtypes.h"
...
#endif                               /* RTW_HEADER_Meas_Noise_Test_private_h_ */
