...
MODEL                := Meas_Noise_Test
MODULES              := Meas_Noise_Test_data.c Meas_Noise_Test_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := Meas_Noise_Test.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := Meas_Noise_Test_ref.rsp
