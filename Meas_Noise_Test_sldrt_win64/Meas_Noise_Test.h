...
#ifndef RTW_HEADER_Meas_Noise_Test_h_
#define RTW_HEADER_Meas_Noise_Test_h_
#ifndef Meas_Noise_Test_COMMON_INCLUDES_
#define Meas_Noise_Test_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* Meas_Noise_Test_COMMON_INCLUDES_ */

#include "Meas_Noise_Test_types.h"
#include <stddef.h>
...
#define Meas_Noise_Test_rtModel        RT_MODEL_Meas_Noise_Test_T

/* Block signals (default storage) */
typedef struct {
  char_T StreamInput_o1[256];          /* '<S2>/Stream Input' */
  char_T StreamInput_o2[256];          /* '<S2>/Stream Input' */
  char_T StreamInput_o3[256];          /* '<S2>/Stream Input' */
  char_T StreamInput_o4[256];          /* '<S2>/Stream Input' */
  char_T StreamInput_o5[256];          /* '<S2>/Stream Input' */
  char_T StreamInput_o6[256];          /* '<S2>/Stream Input' */
  char_T StreamInput_o7[256];          /* '<S2>/Stream Input' */
  char_T StreamInput_o8[256];          /* '<S2>/Stream Input' */
  char_T StreamInput_o9[256];          /* '<S2>/Stream Input' */
  real_T bx;                           /* '<S2>/Gain' */
  real_T IMUx;                         /* '<S2>/String to Double4' */
  real_T Gain1;                        /* '<S3>/Gain1' */
  real_T GyroX;                        /* '<S2>/String to Double5' */
  real_T Gain1_i;                      /* '<S4>/Gain1' */
  real_T by;                           /* '<S2>/Gain2' */
  real_T IMUy;                         /* '<S2>/String to Double6' */
...
} DW_Meas_Noise_Test_T;

/* Backward compatible GRT Identifiers */
#define rtB                            Meas_Noise_Test_B
#define BlockIO                        B_Meas_Noise_Test_T
#define rtP                            Meas_Noise_Test_P
#define Parameters                     P_Meas_Noise_Test_T
#define rtDWork                        Meas_Noise_Test_DW
#define D_Work                         DW_Meas_Noise_Test_T
...
struct tag_RTM_Meas_Noise_Test_T {
  const char_T *path;
...
extern P_Meas_Noise_Test_T Meas_Noise_Test_P;

/* Block signals (default storage) */
extern B_Meas_Noise_Test_T Meas_Noise_Test_B;

/* Block states (default storage) */
extern DW_Meas_Noise_Test_T Meas_Noise_Test_DW;

/* Model entry point functions */
extern void Meas_Noise_Test_initialize(void);
extern void Meas_Noise_Test_output(void);
extern void Meas_Noise_Test_update(void);
extern void Meas_Noise_Test_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Meas_Noise_Test_rtModel *Meas_Noise_Test(void);
...
extern RT_MODEL_Meas_Noise_Test_T *const Meas_Noise_Test_M;
 ...
 *
 * '<Root>' : 'Meas_Noise_Test'
 * '<S1>'   : 'Meas_Noise_Test/Serial Torque Send'
 * '<S2>'   : 'Meas_Noise_Test/SystemParameterReceive'
 * '<S3>'   : 'Meas_Noise_Test/SystemParameterReceive/Degrees to Radians'
